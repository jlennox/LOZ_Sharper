...
{
    PlayerWalk_NoShield_Right,
    PlayerWalk_NoShield_Left,
    PlayerWalk_NoShield_Down,
    PlayerWalk_NoShield_Up,
    PlayerWalk_LittleShield_Right,
    PlayerWalk_LittleShield_Left,
    PlayerWalk_LittleShield_Down,
    PlayerWalk_LittleShield_Up,
    PlayerWalk_BigShield_Right,
    PlayerWalk_BigShield_Left,
    PlayerWalk_BigShield_Down,
    PlayerWalk_BigShield_Up,
    PlayerThrust_Right,
    PlayerThrust_Left,
    PlayerThrust_Down,
    PlayerThrust_Up,
    ...
    B3_Princess_Lift = BossAnimationIds.B3_Princess_Lift,
    B3_Princess_Stand = BossAnimationIds.B3_Princess_Stand,
